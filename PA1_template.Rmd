...
```
Plotting
```{r plotting HIST,fig.height=4,fig.width=6}
library(ggplot2)
...
Plotting
```{r plotting TIME_S,fig.height=4,fig.width=6}
...
```{r plotting 3TIME_S,fig.height=6,fig.width=6}
library(reshape2)
...
```{r plotting 3TIME_S2,fig.height=6,fig.width=6}
g3+geom_line()+facet_grid(facets=.~Weekday)
